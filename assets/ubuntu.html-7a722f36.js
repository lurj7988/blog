import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as i,o as l,c as t,b as n,d as s,f as c,e as p}from"./app-bb1020cc.js";const o={},d=n("h2",{id:"磁盘分区与挂载",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#磁盘分区与挂载","aria-hidden":"true"},"#"),s(" 磁盘分区与挂载")],-1),r={href:"https://blog.csdn.net/make_progress/article/details/118571375",target:"_blank",rel:"noopener noreferrer"},u=p(`<h3 id="查看空闲磁盘空间" tabindex="-1"><a class="header-anchor" href="#查看空闲磁盘空间" aria-hidden="true">#</a> 查看空闲磁盘空间</h3><p>进入以后，m表示帮助，F表示查看空闲的磁盘，q表示退出，d表示删除分区，n表示新建分区，w表示保存配置等</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>lurj@lurj:~$ <span class="token function">sudo</span> <span class="token function">fdisk</span> /dev/sda
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,18);function m(b,v){const a=i("ExternalLinkIcon");return l(),t("div",null,[d,n("p",null,[n("a",r,[s("参考链接"),c(a)])]),u])}const f=e(o,[["render",m],["__file","ubuntu.html.vue"]]);export{f as default};
