import{_ as o}from"./plugin-vue_export-helper-c27b6911.js";import{r as p,o as l,c as i,b as n,d as s,f as e,e as t}from"./app-7eade270.js";const c={},u=n("h2",{id:"一、visual-studio-code相关信息",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#一、visual-studio-code相关信息","aria-hidden":"true"},"#"),s(" 一、Visual Studio Code相关信息")],-1),r={href:"https://code.visualstudio.com/download",target:"_blank",rel:"noopener noreferrer"},d=t("<li>VS Code建议安装插件列表： <ul><li>中文菜单： <ul><li>MS-CEINTL.vscode-language-pack-zh-hans</li></ul></li><li>SSH远程开发： <ul><li>ms-vscode-remote.remote-ssh</li><li>ms-vscode-remote.remote-ssh-edit</li><li>ms-vscode.remote-explorer</li></ul></li><li>C++开发 <ul><li>ms-vscode.cpptools</li></ul></li><li>python开发 <ul><li>ms-python.python</li></ul></li><li>代码补全 <ul><li>TabNine.tabnine-vscode</li><li>GitHub.copilot</li></ul></li></ul></li>",1),k=n("li",null,"本地Ubuntu示例",-1),v={href:"https://www.autodl.com/home",target:"_blank",rel:"noopener noreferrer"},m=n("li",null,"省钱妙招：无卡启动（不挂载GPU，￥0.1/h左右）",-1),b=t(`<h2 id="二、python开发环境配置" tabindex="-1"><a class="header-anchor" href="#二、python开发环境配置" aria-hidden="true">#</a> 二、Python开发环境配置</h2><ul><li>建议<code>conda</code>虚拟环境</li><li>测试代码<code>demo.py</code>：</li></ul><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># python 代码测试</span>
